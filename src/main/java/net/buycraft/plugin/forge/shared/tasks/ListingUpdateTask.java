...
import net.buycraft.plugin.forge.common.data.Category;
import net.buycraft.plugin.forge.common.data.Package;
import net.buycraft.plugin.forge.common.data.responses.Listing;
